    ...
    <div id="heroCarousel" class="container carousel carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
      ...
      <div class="carousel-item active">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">Welcome to <span>Chalyma Real Estate</span></h2>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="fade-up">
            <div class="icon-box icon-box-pink">
              ...
              <h4 class="title"><a href="{{route('home-rentals')}}">Dashboard Rentals</a></h4>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box icon-box-cyan">
              ...
              <h4 class="title"><a href="{{route('home-sales')}}">Dashboards For Sale</a></h4>
    ...
    <section class="features">
      <div class="container">
        ...
        <div class="row" data-aos="fade-up">
          <div class="col-md-5">
            <img src="{{asset('asset/img/features-1.svg')}}" class="img-fluid" alt="">
          </div>
        ...
        <div class="row" data-aos="fade-up">
          <div class="col-md-5">
            <img src="{{asset('asset/img/features-3.svg')}}" class="img-fluid" alt="">
          </div>
