...
<section class="vh-80" style=" margin-bottom:20%; width:100%; ">
                    ...
                    <div class="card-body p-md-5">
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                ...
                                <form action="{{route('signup-form')}}" method="post" class="mx-1 mx-md-4" enctype="multipart/form-data">
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                                        <div class="form-outline flex-fill mb-0">
                                            <input type="email" id="form3Example1c" name="email" class="form-control" required />
                                    ...
                                    <select id="stateSelect" class="form-select" name="state">
                                        <option value="" hidden>select state or region</option>

                                    </select>
                                    <label class="form-label" for="form3Example3c">Select State Or Region</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                                        <div class="form-outline flex-fill mb-0">
                                            <input type="number" id="form3Example1c" name="phone" class="form-control" required />
                                    ...
                                    <div class="form-check d-flex justify-content-center mb-5">
                                        <input class="form-check-input me-2" type="checkbox" name="agree" value="on" id="form2Example3c" required />
                            ...
                            <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                                ...
                                <img src="{{asset('asset/img/homeowner.png')}}" class="img-fluid" alt="Sample image" style="width: 200px;height:200px">
