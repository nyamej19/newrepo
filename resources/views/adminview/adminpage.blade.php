        ...
        <div class="row">
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="fade-up">
                <div class="icon-box icon-box-pink">
                    <div class="icon"><img src="./asset/img/addhouse.png" style="width: 50px;height:50px"></div>
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                <div class="icon-box icon-box-cyan">
                    <div class="icon"><img src="./asset/img/asset-management.png" style="width: 50px;height:50px"></div>
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                <div class="icon-box icon-box-cyan">
                    <div class="icon"><img src="./asset/img/wrench.png" style="width: 50px;height:50px"></div>
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
                <div class="icon-box icon-box-green">
                    <div class="icon"><img src="./asset/img/outsourcing.png" style="width: 50px;height:50px"></div>
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
                <div class="icon-box icon-box-blue">
                    <div class="icon"><img src="./asset/img/behavior.png" style="width: 50px;height:50px"></div>
